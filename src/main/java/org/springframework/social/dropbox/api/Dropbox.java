...
public interface Dropbox {
	...
	/**
	 * Restore a file to a revision Will also restore an deleted file
	 * 
	 * @param path
	 * @param rev
	 * @return Metadata
	 ...
	 */
	ListFolder getListFolder(String path);
	 ...
	 */
	TemporaryLink getTemporaryLink(String path);
